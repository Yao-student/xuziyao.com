...
urlpatterns = [
    ...
    path('notanote/imgshare/', views.notanote_imgshare, name='notanote_imgshare'),
    path('notanote/imgshare/upload/', views.notanote_imgshare_upload, name='notanote_imgshare_upload'),
