...
- [Notanote 查分器](http://xuziyao.com/notanote/best/) 同步 v2.6.0 更新，并修复 bug
- 修复 [Notanote PC 端下载](http://xuziyao.com/notanote/pcdownload/) 无法正确下载文件的问题
- 将 &lt;style&gt; 元素中的 CSS 移动至单独的 CSS 文件

### v2.2.0 (2025.09.18)

- [Notanote 查分器](http://xuziyao.com/notanote/rank/) 同步 v2.5.1 更新，修复 bug、增加 PERFECT、GOOD、BAD、MISS 显示、增加显示记录总数选项
- 增加 [Notanote PC 端下载](http://xuziyao.com/notanote/pcdownload/)
- 祝我自己 15 岁生日快乐！
- 其他小更改
